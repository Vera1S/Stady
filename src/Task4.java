public class Task4 {
    ...
    //5. Создать условие (если i < min значения, то min значение = i; и если (i > max значения), то max значение = i;
    //6. Создать временную переменую "temp" = value.get(i) и
    //7. Поменять местами через временную переменную
}
